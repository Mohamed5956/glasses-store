    ...
    <div id="app">
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center px-xl-5">
                ...
                <div class="col-lg-6 col-6 text-center"></div>

                <div class="col-lg-3 col-6 text-end"> <!-- Modified class to col-6 text-end -->
                    <div class="nav-item">
...
<!-- Footer End -->
    ...
    <!-- Back to Top -->
    <a href="#" class="btn back-to-top" style="background-color: black;color:white"><i  class="fa fa-angle-double-up"></i></a>
